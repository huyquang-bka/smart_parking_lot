...
# Form implementation generated from reading ui file 'd:\self_project\datn_ne_q\resources\layouts\widget_in.ui'
#
...
"border-radius: 6px;")
        ...
        self.qline_slot.setGeometry(QtCore.QRect(180, 99, 111, 31))
...
"        }")
        ...
        self.qframe_map = QtWidgets.QFrame(WidgetIn)
...
"border-radius: 6px;")
        ...
        self.gridLayout_3 = QtWidgets.QGridLayout(self.qframe_map)
        self.gridLayout_3.setObjectName("gridLayout_3")
        self.groupBox_B = QtWidgets.QGroupBox(self.qframe_map)
        self.groupBox_B.setObjectName("groupBox_B")
        self.gridLayout_3.addWidget(self.groupBox_B, 0, 1, 1, 1)
        self.groupBox_D = QtWidgets.QGroupBox(self.qframe_map)
        self.groupBox_D.setObjectName("groupBox_D")
        self.gridLayout_3.addWidget(self.groupBox_D, 0, 3, 1, 1)
        self.groupBox_C = QtWidgets.QGroupBox(self.qframe_map)
        self.groupBox_C.setObjectName("groupBox_C")
        self.gridLayout_3.addWidget(self.groupBox_C, 0, 2, 1, 1)
        
        #A 
        self.groupBox_A = QtWidgets.QGroupBox(self.qframe_map)
        self.groupBox_A.setObjectName("groupBox_A")
        self.gridLayout_4 = QtWidgets.QGridLayout(self.groupBox_A)
        self.gridLayout_4.setObjectName("gridLayout_4")
        self.gridLayout_3.addWidget(self.groupBox_A, 0, 0, 1, 1)
        
        self.gridLayout.addWidget(self.qframe_map, 0, 1, 1, 1)
